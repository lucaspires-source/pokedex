...
export default class Pokemon extends Component {
  ...
  async componentDidMount() {
    ...
    const height =
      Math.round(pokemonRes.data.height / 0.10000)
        ...
        <div className="card">
          <div className="card-header">
            <div className="row">
              ...
              <div className="col-7">
                <div className="float-right"  class="text-capitalize">
          ...
          <div className="card-body">
            <div className="row align-items-center">
              ...
              <div className="col-md-9">
                <h4 className="mx-auto"  class="text-capitalize">
                  {this.state.name}
                </h4>
                <div className="row align-items-center">
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="row">
                  ...
                  <div className="col-6">
                    <h6 className="float-left"  class="text-capitalize" >{this.state.abilities}</h6>
                  </div>
                  <div className="col-6">
